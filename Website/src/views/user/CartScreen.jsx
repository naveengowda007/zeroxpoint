...
export default function CartScreen(props) {
  ...
  const RenderCart = useMemo(() => {
    return CartData.map((item) => (
      <CartItem item={item} key={JSON.stringify(item)} setItem={setItem} />
    ));
  }, [CartData, setItem]);
          ...
          <Flex gap={10} mt={2}>
            ...
            <VStack align="center" w="full" maxW="550px" spacing={4}>
              ...
              {DeliveryLocation?.length < 1 && (
                <AddAddress
                  ...
                  setOpenLocationModal={() =>
                    history.push("/user/profile?addAddress=true")
                  }
                />
              )}
              ...
              <Button
                ...
                borderWidth={1}
                onClick={() => history.push("/user/calculate")}
              >
                <Image src={InfoSvg} w="22px" h="22px" />
                <Text fontFamily="DM sans" color="black" px={4}>
              ...
              {cartPrice === null && (
                ...
                >
                  <Flex
                    bgGradient="linear(to-l, #d4fc79, #96e6a1)"
                    p={5}
                    style={{
                      maxWidth: 600,
                      flex: 1,
                  ...
                  >
                    ...
                    >
                      {IsLoading ? (
                        ...
                        <Text color="#eff" fontFamily="DM sans">
                          Upload Files to Get Price
                        </Text>
                      )}
                    </Button>
                  </Flex>
                  ...
                  >
                    {ExpandBill && (
                      <Box
                        ...
                        m={2}
                      >
                        <Text fontWeight="500" fontFamily="DM sans" mb={4}>
                          Printing Charge: ₹{" "}
                          {cartPrice - DeliveryLocation.length * DeliveryCharge}
                        </Text>
                        <Text fontWeight="500" fontFamily="DM sans">
                    ...
                    >
                      <IconButton
                        ...
                        icon={
                          <ChevronDownIcon
                            transform={
                              ExpandBill ? "rotate(0deg)" : "rotate(180deg)"
                            }
                          />
                        }
                      ...
                      <Text fontFamily="DM sans" fontWeight="bold" mr={4}>
                        Total: ₹ {cartPrice}
                      </Text>
                      ...
                      >
                        {IsLoading ? (
                          ...
                          <Text color="#eff" fontFamily="DM sans" px="10px">
                            Pay Now
                          </Text>
                        )}
                      </Button>
